...
class TestSpeakerConfigMerging:
    ...
    def create_default_config(
        self, config_dir: Path, speakers_config: list, default_speaker: str
    ):
    ...
    def test_scenario_1_only_reference_audio_override(
        ...
        merged_config = config_manager.load_cascading_config(
            temp_config_dir / "test_job.yaml"
        )
        ...
        logger.info(
            "✅ Scenario 1 passed: reference_audio overridden, tts_params inherited"
        )
    ...
    def test_scenario_2_change_default_speaker(self, config_manager, temp_config_dir):
        ...
        job_config = {"generation": {"default_speaker": "narrator"}}
    ...
    def test_scenario_3_override_non_default_speaker(
        self, config_manager, temp_config_dir
    ):
        """
        ...
        job_config = {
            "generation": {
                "speakers": [{"id": "narrator", "reference_audio": "new_narrator.wav"}]
            }
        }
    ...
    def test_scenario_4_complex_speaker_and_default_change(
        self, config_manager, temp_config_dir
    ):
        """
        ...
        job_config = {
            "generation": {
                ...
                "speakers": [
                    {"id": "david", "reference_audio": "new_david.wav"},
                    {
                        "id": "character",
                        "reference_audio": "new_character.wav",
                        "tts_params": {"exaggeration": 0.8},  # Partial override
                    },
                ],
            }
        }
        ...
        logger.info(
            "✅ Scenario 4 passed: Complex multi-speaker and default change worked correctly"
        )
    ...
    def test_new_speaker_with_default_fallback(self, config_manager, temp_config_dir):
        ...
        self.create_default_config(
            temp_config_dir, default_speakers, "narrator"
        )  # narrator is default
        ...
        logger.info(
            "✅ New speaker inheritance test passed: inherited from default speaker, not first speaker"
        )
    ...
    def test_invalid_default_speaker_fallback(self, config_manager, temp_config_dir):
        ...
        self.create_default_config(
            temp_config_dir, default_speakers, "nonexistent"
        )  # Invalid default

        # Load and merge configs
        merged_config = config_manager.load_cascading_config(
            temp_config_dir / "default_config.yaml"
        )

        # Should automatically fix the invalid default_speaker
        assert (
            merged_config["generation"]["default_speaker"] == "david"
