...
class TestCLIMapper:
    ...
    def test_strategy_to_options_mapping(self):
        ...
        latest_new_options = self.cli_mapper.strategy_to_options[ExecutionStrategy.LATEST_NEW]
    ...
    def test_parse_mode_argument(self):
        ...
        # Mixed strategies
        job_strat, global_strat = self.cli_mapper._parse_mode_argument("job1:all,job2:latest-new,new")
...
class TestIntegrationScenarios:
    ...
    def test_cli_to_menu_equivalence(self):
        ...
        assert cli_intent.execution_options.force_final_generation == menu_intent.execution_options.force_final_generation
    ...
    def test_semantic_improvement_add_final(self):
        ...
        options = ExecutionOptions(force_final_generation=True)  # Clearly forces generation
