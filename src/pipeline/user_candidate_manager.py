...
class UserCandidateManager:
    ...
    def show_candidate_overview(self, task_info: Dict) -> None:
        ...
        for i, chunk in enumerate(chunks):
            chunk_key = str(i)
            selected_candidate = int(self.current_selections.get(chunk_key, 0)) + 1  # Convert to 1-based
            ...
            while True:
                ...
                if choice.lower() == 'c':
                    ...
                    if 1 <= candidate_num <= len(candidate_infos):
                        ...
                        print(f"Invalid choice. Please enter 1-{len(candidate_infos)} or 'c'")
                else:
                    print(f"Invalid choice. Please enter 1-{len(candidate_infos)} or 'c'")
        ...
        try:
            ...
            for candidate_key, candidate_data in candidates.items():
                ...
                info = CandidateInfo(
                    ...
                    validation_passed=candidate_data.get("overall_quality_score", 0.0) > 0.6,
    ...
    def _get_changed_chunks(self) -> Set[int]:
        ...
        for chunk_key in set(self.original_selections.keys()) | set(self.current_selections.keys()):
